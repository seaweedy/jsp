...
import kr.or.ddit.board.model.Person;
...
public class IocDITest {
	...
	// person 스프링빈의 age(value), boardRespository(ref) 두 속성에 주입이 잘 되었는지 확인
	@Test
	...
	// 동일한 빈이므로 두 객체의 getter 메서드를 통해 얻어온 boardRespository 객체는 동일해야
	// 한다.
	@Test
